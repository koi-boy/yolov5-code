...
Usage:
    ...
    train: weights=weights/yolov5s.pt, cfg=models/yolov5s.yaml, data=data/VOC.yaml, hyp=data/hyps/hyp.scratch.yaml, 
    epochs=20, batch_size=4, img_size=[640, 640], resume=False, nosave=False, notest=False, workers=0, device=, 
    single_cls=False, rect=False, noautoanchor=False, evolve=False, multi_scale=True, label_smoothing=0.0, 
    adam=False, sync_bn=False, linear_lr=False, cache_images=False, image_weights=True, bucket=, 
    project=runs/train, name=exp, exist_ok=False, quad=False, save_period=-1, artifact_alias=latest, 
...
def parse_opt(known=False):
    ...
    parser.add_argument('--evolve', default=False, action='store_true', help='evolve hyperparameters') #遗传算法 
